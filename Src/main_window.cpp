...
: wxFrame(NULL,wxID_ANY, title, pos, size, wxSYSTEM_MENU | wxMINIMIZE_BOX | wxCLOSE_BOX | wxCAPTION | wxCLIP_CHILDREN)
{
    ...
    statusupdate = new wxStaticText(winupdate, wxID_ANY, "Windows update status is", wxDefaultPosition, wxDefaultSize);
    ...
    statustarget = new wxCheckBox(advanced_panel, wxID_ANY, "Stop/Start windows update", wxDefaultPosition, wxDefaultSize);
    ...
    action = new wxButton(winupdate, wxID_ANY, "Turn On", wxDefaultPosition, normal_btn);
